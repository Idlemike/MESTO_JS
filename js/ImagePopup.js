class ImagePopup extends Popup {
    constructor(
        popupWindowPicture,
        popupWindowPictureContainer, popupPictureClose
        /*
         Можно лучше:
...
/*
// работать должно так
loadImage('https://yastatic.net/q/logoaas/v1/Практикум.svg')
    .then((image) => {
        document.body.appendChild(image);
    })
    .catch((error) => {
        if (!event || event.type === "error") {
            console.error("Couldn't load/decode the image: ", error);
        }
    });*/
/*
 Можно лучше:
